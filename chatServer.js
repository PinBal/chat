...
// Get the ip whitelist json file and set options

var fs = require('fs');
var contents = fs.readFileSync('ips.json', 'utf8');
var jsondata = JSON.parse(contents);
var whitelist = jsondata.ips;
var options = {
	mode: 'allow',
	allows: whitelist,
	forceConnectionAddress: false,
	log: function(clientIp, access){
		console.log(clientIp + (access ? ' accessed a file from the server' : ' denied.'));
	},
